...
veg.sum <- veg.sum %>%
                mutate(gram_prop_se_max = mean+se, 
                       gram_prop_se_min = mean-se)
...
model <- ggplot() +
  ...
  theme_classic() +
  labs(x = "Disurbance", 
       y = "Plot proportion of tall perennial graminoids") +
...
##~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
## tpg seed as relabund, playing with distribution -> this doesn't seem to help; delete if binomial distribution is good. 
